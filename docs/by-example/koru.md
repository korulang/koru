...
> 75 passing positive tests, verbatim from `tests/regression/`. Generated by `scripts/generate-skills.js`.
...
- **CORE LANGUAGE / EVENTS FLOWS** — 25 tests
- **CORE LANGUAGE / LITERALS** — 4 tests
- **CORE LANGUAGE / TYPE SYSTEM** — 5 tests
- **CORE LANGUAGE / CONTROL FLOW** — 22 tests
- **PARSER** — 2 tests
