...
> 99 passing positive tests, verbatim from `tests/regression/`. Generated by `scripts/generate-skills.js`.
...
- **CORE LANGUAGE / BASIC SYNTAX** — 18 tests
- **CORE LANGUAGE / EVENTS FLOWS** — 33 tests
- **CORE LANGUAGE / LITERALS** — 6 tests
- **CORE LANGUAGE / TYPE SYSTEM** — 3 tests
...
### 010_065_reject_leading_underscore_binding
...
### 100_015_bare_event_impl_needs_switch
