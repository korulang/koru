...
> 102 passing positive tests, verbatim from `tests/regression/`. Generated by `scripts/generate-skills.js`.
...
- **CORE LANGUAGE / EVENTS FLOWS** — 33 tests
- **CORE LANGUAGE / LITERALS** — 6 tests
- **CORE LANGUAGE / TYPE SYSTEM** — 8 tests
...
### 020_062_kebab_branch_across_a_module_boundary
...
### 030_018_string_escape_backslash_then_quote
...
### 030_111_generic_struct_two_params
...
### 030_113_generic_struct_with_primitives
...
tor data { x: i32, y: i32 } -> { x: i32, y: i32 }
