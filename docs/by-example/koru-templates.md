...
> 18 passing positive tests, verbatim from `tests/regression/`. Generated by `scripts/generate-skills.js`.
...
~pub event clock { passes: i64 } -> i64
...
### 320_099_sequential_for_phases_under_capture
