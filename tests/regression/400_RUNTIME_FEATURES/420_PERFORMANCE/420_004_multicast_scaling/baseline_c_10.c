// C Function Pointer Baseline - 10 Handlers
...
static volatile uint64_t sum6 = 0, sum7 = 0, sum8 = 0, sum9 = 0, sum10 = 0;
...
void handler6(uint64_t value) { sum6 += value; }
void handler7(uint64_t value) { sum7 += value; }
void handler8(uint64_t value) { sum8 += value; }
void handler9(uint64_t value) { sum9 += value; }
void handler10(uint64_t value) { sum10 += value; }
...
int main(void) {
    ...
    if (sum1 == expected && sum2 == expected && sum3 == expected && sum4 == expected && sum5 == expected &&
        sum6 == expected && sum7 == expected && sum8 == expected && sum9 == expected && sum10 == expected) {
