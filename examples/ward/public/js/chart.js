...
function hideDataset(element)
{
    switch (String(element.id))
    {
        ...
        {
            processorTriangle.style.animation = (chart.getDatasetMeta(0).hidden) ? "fade-in-square 0.5s forwards" : "fade-out-square 0.5s forwards";
        ...
        case "ram-rectangle":
        {
            ramTriangle.style.animation = (chart.getDatasetMeta(1).hidden) ? "fade-in-square 0.5s forwards" : "fade-out-square 0.5s forwards";
        ...
        {
            storageTriangle.style.animation = (chart.getDatasetMeta(2).hidden) ? "fade-in-square 0.5s forwards" : "fade-out-square 0.5s forwards";
