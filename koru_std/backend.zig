    ...
    .items = &[_]Item{
        .{ .module_decl = .{ .logical_name = "std.compiler", .canonical_path = "/Users/larsde/src/koru/koru_std/compiler.kz", .items = &[_]Item{            
                ...
                .module = "compiler",
                                    ...
                                    .{ .host_line = .{ .content = "// Structural shape checker implementation", .location = .{ .line = 1751, .column = 0, .file = "/Users/larsde/src/koru/koru_std/compiler.kz" }, .module = "compiler" } },            
                                    .{ .proc_decl = ProcDecl{
                .path = .{ .module_qualifier = "std.compiler", .segments = &[_][]const u8{"check_structure"} },
                .body = 
                    \\
                ...
                .module = "compiler",
                                    ...
                                    .{ .host_line = .{ .content = "// Flow checker implementation", .location = .{ .line = 1839, .column = 0, .file = "/Users/larsde/src/koru/koru_std/compiler.kz" }, .module = "compiler" } },            
                                    .{ .host_line = .{ .content = "// Validates control flow properties like when-clause exhaustiveness", .location = .{ .line = 1840, .column = 0, .file = "/Users/larsde/src/koru/koru_std/compiler.kz" }, .module = "compiler" } },            
                                    .{ .proc_decl = ProcDecl{
                .path = .{ .module_qualifier = "std.compiler", .segments = &[_][]const u8{"check_flow"} },
                .body = 
                    \\
                ...
                .is_pure = false,
                .is_transitively_pure = false,
                .location = .{ .line = 1916, .column = 0, .file = "/Users/larsde/src/koru/koru_std/compiler.kz" },
                .module = "compiler",
            } },            
                                    .{ .host_line = .{ .content = "// Auto-discharge inserter implementation", .location = .{ .line = 1917, .column = 0, .file = "/Users/larsde/src/koru/koru_std/compiler.kz" }, .module = "compiler" } },            
                                    .{ .host_line = .{ .content = "// Inserts disposal calls before terminators when exactly one disposal option exists", .location = .{ .line = 1918, .column = 0, .file = "/Users/larsde/src/koru/koru_std/compiler.kz" }, .module = "compiler" } },            
                                    .{ .host_line = .{ .content = "// Flags for auto-discharge control (co-located with implementation!)", .location = .{ .line = 1920, .column = 0, .file = "/Users/larsde/src/koru/koru_std/compiler.kz" }, .module = "compiler" } },            
                                    .{ .flow = Flow{
                .invocation = Invocation{
                    .path = .{ .module_qualifier = "std.compiler", .segments = &[_][]const u8{"flag", "declare"} },
                    .args = &[_]Arg{
                ...
                .is_pure = true,
                .is_transitively_pure = false,
                .location = .{ .line = 1921, .column = 0, .file = "/Users/larsde/src/koru/koru_std/compiler.kz" },
                .impl_of = null,
                .is_impl = false,
                .module = "compiler",
            } },            
                ...
                .module = "compiler",
                                    ...
                                    .{ .host_line = .{ .content = "// Semantic phantom type checker implementation", .location = .{ .line = 2013, .column = 0, .file = "/Users/larsde/src/koru/koru_std/compiler.kz" }, .module = "compiler" } },            
                                    .{ .host_line = .{ .content = "// Validates module-qualified phantom states and their compatibility", .location = .{ .line = 2014, .column = 0, .file = "/Users/larsde/src/koru/koru_std/compiler.kz" }, .module = "compiler" } },            
                                    .{ .proc_decl = ProcDecl{
                .path = .{ .module_qualifier = "std.compiler", .segments = &[_][]const u8{"check_phantom_semantic"} },
                .body = 
                    \\
                ...
                .is_pure = false,
                .is_transitively_pure = false,
                .location = .{ .line = 2091, .column = 0, .file = "/Users/larsde/src/koru/koru_std/compiler.kz" },
                .module = "compiler",
            } },            
                                    .{ .host_line = .{ .content = "// Purity checker implementation", .location = .{ .line = 2092, .column = 0, .file = "/Users/larsde/src/koru/koru_std/compiler.kz" }, .module = "compiler" } },            
                                    .{ .host_line = .{ .content = "// Tracks [pure] annotations - developer assertion, trusted without verification", .location = .{ .line = 2093, .column = 0, .file = "/Users/larsde/src/koru/koru_std/compiler.kz" }, .module = "compiler" } },            
                                    .{ .proc_decl = ProcDecl{
                .path = .{ .module_qualifier = "std.compiler", .segments = &[_][]const u8{"check_purity"} },
                .body = 
                    \\
                ...
                .is_pure = false,
                .is_transitively_pure = false,
                .location = .{ .line = 2104, .column = 0, .file = "/Users/larsde/src/koru/koru_std/compiler.kz" },
                .module = "compiler",
            } },            
                                    .{ .host_line = .{ .content = "// Dead Strip Pass", .location = .{ .line = 2105, .column = 0, .file = "/Users/larsde/src/koru/koru_std/compiler.kz" }, .module = "compiler" } },            
                                    .{ .host_line = .{ .content = "// Removes unreachable events and flows from the AST", .location = .{ .line = 2106, .column = 0, .file = "/Users/larsde/src/koru/koru_std/compiler.kz" }, .module = "compiler" } },            
                                    .{ .host_line = .{ .content = "// Walks from entry points (top-level flows), marks reachable events, prunes the rest", .location = .{ .line = 2107, .column = 0, .file = "/Users/larsde/src/koru/koru_std/compiler.kz" }, .module = "compiler" } },            
                                    .{ .proc_decl = ProcDecl{
                .path = .{ .module_qualifier = "std.compiler", .segments = &[_][]const u8{"pass_dead_strip"} },
                .body = 
                    \\
                ...
                .is_pure = false,
                .is_transitively_pure = false,
                .location = .{ .line = 2125, .column = 0, .file = "/Users/larsde/src/koru/koru_std/compiler.kz" },
                .module = "compiler",
            } },            
                                    .{ .host_line = .{ .content = "// CCP Observability Injection Pass", .location = .{ .line = 2126, .column = 0, .file = "/Users/larsde/src/koru/koru_std/compiler.kz" }, .module = "compiler" } },            
                                    .{ .host_line = .{ .content = "// Injects universal observability taps into the user's AST", .location = .{ .line = 2127, .column = 0, .file = "/Users/larsde/src/koru/koru_std/compiler.kz" }, .module = "compiler" } },            
                                    .{ .host_line = .{ .content = "// This makes every compiled program self-observing by adding emit_json and ~* -> * tap", .location = .{ .line = 2128, .column = 0, .file = "/Users/larsde/src/koru/koru_std/compiler.kz" }, .module = "compiler" } },            
                                    .{ .proc_decl = ProcDecl{
                .path = .{ .module_qualifier = "std.compiler", .segments = &[_][]const u8{"inject_ccp"} },
                .body = 
                    \\
                ...
                .is_pure = false,
                .is_transitively_pure = false,
                .location = .{ .line = 2144, .column = 0, .file = "/Users/larsde/src/koru/koru_std/compiler.kz" },
                .module = "compiler",
            } },            
                                    .{ .host_line = .{ .content = "// CCP Command Processing Pass", .location = .{ .line = 2145, .column = 0, .file = "/Users/larsde/src/koru/koru_std/compiler.kz" }, .module = "compiler" } },            
                                    .{ .host_line = .{ .content = "// Reads and processes incoming AI commands from stdin when --ccp is enabled", .location = .{ .line = 2146, .column = 0, .file = "/Users/larsde/src/koru/koru_std/compiler.kz" }, .module = "compiler" } },            
                                    .{ .event_decl = EventDecl{
                .path = .{ .module_qualifier = "std.compiler", .segments = &[_][]const u8{"process_ccp_commands"} },
                .input = Shape{ .fields = &[_]Field{
                    Field{ .name = "ctx", .type = "CompilerContext", .module_path = null, .is_source = false, .is_file = false, .is_embed_file = false, .is_expression = false, .is_invocation_meta = false, .phantom = null, .expression = null, .expression_str = null, .owns_expression = false },
                ...
                .location = .{ .line = 2149, .column = 0, .file = "/Users/larsde/src/koru/koru_std/compiler.kz" },
                .module = "compiler",
                .is_pure = false,
                .is_transitively_pure = false,
            } },            
                ...
                .is_pure = false,
                .is_transitively_pure = false,
                .location = .{ .line = 2159, .column = 0, .file = "/Users/larsde/src/koru/koru_std/compiler.kz" },
                .module = "compiler",
            } },            
                                    .{ .host_line = .{ .content = "// ============================================================================", .location = .{ .line = 2160, .column = 0, .file = "/Users/larsde/src/koru/koru_std/compiler.kz" }, .module = "compiler" } },            
                                    .{ .host_line = .{ .content = "// NOTE: The default compiler coordinator is NOT defined as a Koru flow.", .location = .{ .line = 2161, .column = 0, .file = "/Users/larsde/src/koru/koru_std/compiler.kz" }, .module = "compiler" } },            
                                    .{ .host_line = .{ .content = "//       It's hardcoded in src/main.zig as a Zig function.", .location = .{ .line = 2162, .column = 0, .file = "/Users/larsde/src/koru/koru_std/compiler.kz" }, .module = "compiler" } },            
                                    .{ .host_line = .{ .content = "//", .location = .{ .line = 2163, .column = 0, .file = "/Users/larsde/src/koru/koru_std/compiler.kz" }, .module = "compiler" } },            
                                    .{ .host_line = .{ .content = "// Why: The coordinator runs at Zig compile-time during backend.zig compilation,", .location = .{ .line = 2164, .column = 0, .file = "/Users/larsde/src/koru/koru_std/compiler.kz" }, .module = "compiler" } },            
                                    .{ .host_line = .{ .content = "//      before the Koru runtime exists. Flows can't execute at that stage.", .location = .{ .line = 2165, .column = 0, .file = "/Users/larsde/src/koru/koru_std/compiler.kz" }, .module = "compiler" } },            
                                    .{ .host_line = .{ .content = "//", .location = .{ .line = 2166, .column = 0, .file = "/Users/larsde/src/koru/koru_std/compiler.kz" }, .module = "compiler" } },            
                                    .{ .host_line = .{ .content = "// To modify the compilation pipeline, edit compiler_coordinate_default", .location = .{ .line = 2167, .column = 0, .file = "/Users/larsde/src/koru/koru_std/compiler.kz" }, .module = "compiler" } },            
                                    .{ .host_line = .{ .content = "// in src/main.zig directly.", .location = .{ .line = 2168, .column = 0, .file = "/Users/larsde/src/koru/koru_std/compiler.kz" }, .module = "compiler" } },            
                                    .{ .host_line = .{ .content = "//", .location = .{ .line = 2169, .column = 0, .file = "/Users/larsde/src/koru/koru_std/compiler.kz" }, .module = "compiler" } },            
                                    .{ .host_line = .{ .content = "// The pipeline executes these passes in order:", .location = .{ .line = 2170, .column = 0, .file = "/Users/larsde/src/koru/koru_std/compiler.kz" }, .module = "compiler" } },            
                                    .{ .host_line = .{ .content = "//   1. compiler.passes.process_ccp_commands  (reads AI commands from stdin)", .location = .{ .line = 2171, .column = 0, .file = "/Users/larsde/src/koru/koru_std/compiler.kz" }, .module = "compiler" } },            
                                    .{ .host_line = .{ .content = "//   2. compiler.passes.evaluate_comptime     (executes comptime events)", .location = .{ .line = 2172, .column = 0, .file = "/Users/larsde/src/koru/koru_std/compiler.kz" }, .module = "compiler" } },            
                                    .{ .host_line = .{ .content = "//   3. compiler.check.structure              (validates event/branch shapes)", .location = .{ .line = 2173, .column = 0, .file = "/Users/larsde/src/koru/koru_std/compiler.kz" }, .module = "compiler" } },            
                                    .{ .host_line = .{ .content = "//   4. compiler.check.phantom.semantic       (validates phantom types)", .location = .{ .line = 2174, .column = 0, .file = "/Users/larsde/src/koru/koru_std/compiler.kz" }, .module = "compiler" } },            
                                    .{ .host_line = .{ .content = "//   5. compiler.passes.inject_ccp            (adds observability taps)", .location = .{ .line = 2175, .column = 0, .file = "/Users/larsde/src/koru/koru_std/compiler.kz" }, .module = "compiler" } },            
                                    .{ .host_line = .{ .content = "//   6. compiler.passes.dead_strip            (removes unreachable events/flows)", .location = .{ .line = 2176, .column = 0, .file = "/Users/larsde/src/koru/koru_std/compiler.kz" }, .module = "compiler" } },            
                                    .{ .host_line = .{ .content = "//   7. compiler.emit.zig                     (generates final Zig code)", .location = .{ .line = 2177, .column = 0, .file = "/Users/larsde/src/koru/koru_std/compiler.kz" }, .module = "compiler" } },            
                                    .{ .host_line = .{ .content = "//", .location = .{ .line = 2178, .column = 0, .file = "/Users/larsde/src/koru/koru_std/compiler.kz" }, .module = "compiler" } },            
                                    .{ .host_line = .{ .content = "// [expand] events are handled automatically by transform_pass_runner.zig", .location = .{ .line = 2179, .column = 0, .file = "/Users/larsde/src/koru/koru_std/compiler.kz" }, .module = "compiler" } },            
                                    .{ .host_line = .{ .content = "// during the transform phase inside evaluate_comptime.", .location = .{ .line = 2180, .column = 0, .file = "/Users/larsde/src/koru/koru_std/compiler.kz" }, .module = "compiler" } },            
                                    .{ .host_line = .{ .content = "// ============================================================================", .location = .{ .line = 2181, .column = 0, .file = "/Users/larsde/src/koru/koru_std/compiler.kz" }, .module = "compiler" } },        
        ...
        .{ .module_decl = .{ .logical_name = "std.testing", .canonical_path = "/Users/larsde/src/koru/koru_std/testing.kz", .items = &[_]Item{            
                ...
                .location = .{ .line = 891, .column = 0, .file = "/Users/larsde/src/koru/koru_std/testing.kz" },
                .module = "testing",
                .is_pure = true,
                .is_transitively_pure = false,
            } },            
                ...
                .is_pure = true,
                .is_transitively_pure = false,
                .location = .{ .line = 896, .column = 0, .file = "/Users/larsde/src/koru/koru_std/testing.kz" },
                .module = "testing",
            } },            
                                    .{ .host_line = .{ .content = "// Equality assertion", .location = .{ .line = 897, .column = 0, .file = "/Users/larsde/src/koru/koru_std/testing.kz" }, .module = "testing" } },            
                                    .{ .event_decl = EventDecl{
                ...
                .location = .{ .line = 901, .column = 0, .file = "/Users/larsde/src/koru/koru_std/testing.kz" },
                .module = "testing",
                .is_pure = false,
                .is_transitively_pure = false,
            } },            
                                    .{ .host_line = .{ .content = "// TODO: Transform to generate Zig equality check", .location = .{ .line = 902, .column = 0, .file = "/Users/larsde/src/koru/koru_std/testing.kz" }, .module = "testing" } },            
                                    .{ .host_line = .{ .content = "// Contains assertion (for strings/slices)", .location = .{ .line = 904, .column = 0, .file = "/Users/larsde/src/koru/koru_std/testing.kz" }, .module = "testing" } },            
                                    .{ .event_decl = EventDecl{
                ...
                .location = .{ .line = 908, .column = 0, .file = "/Users/larsde/src/koru/koru_std/testing.kz" },
                .module = "testing",
                .is_pure = false,
                .is_transitively_pure = false,
            } },            
                                    .{ .host_line = .{ .content = "// TODO: Transform to generate Zig contains check", .location = .{ .line = 909, .column = 0, .file = "/Users/larsde/src/koru/koru_std/testing.kz" }, .module = "testing" } },            
                                    .{ .host_line = .{ .content = "// =============================================================================", .location = .{ .line = 911, .column = 0, .file = "/Users/larsde/src/koru/koru_std/testing.kz" }, .module = "testing" } },            
                                    .{ .host_line = .{ .content = "// Property Testing", .location = .{ .line = 912, .column = 0, .file = "/Users/larsde/src/koru/koru_std/testing.kz" }, .module = "testing" } },            
                                    .{ .host_line = .{ .content = "// =============================================================================", .location = .{ .line = 913, .column = 0, .file = "/Users/larsde/src/koru/koru_std/testing.kz" }, .module = "testing" } },            
                                    .{ .host_line = .{ .content = "// Test that multiple variants produce equivalent results", .location = .{ .line = 915, .column = 0, .file = "/Users/larsde/src/koru/koru_std/testing.kz" }, .module = "testing" } },            
                                    .{ .host_line = .{ .content = "// Usage:", .location = .{ .line = 916, .column = 0, .file = "/Users/larsde/src/koru/koru_std/testing.kz" }, .module = "testing" } },            
                                    .{ .host_line = .{ .content = "//   ~test.property.equivalent {", .location = .{ .line = 917, .column = 0, .file = "/Users/larsde/src/koru/koru_std/testing.kz" }, .module = "testing" } },            
                                    .{ .host_line = .{ .content = "//       ~ast:select(blur|*)", .location = .{ .line = 918, .column = 0, .file = "/Users/larsde/src/koru/koru_std/testing.kz" }, .module = "testing" } },            
                                    .{ .host_line = .{ .content = "//   }", .location = .{ .line = 919, .column = 0, .file = "/Users/larsde/src/koru/koru_std/testing.kz" }, .module = "testing" } },            
                                    .{ .event_decl = EventDecl{
                ...
                .location = .{ .line = 923, .column = 0, .file = "/Users/larsde/src/koru/koru_std/testing.kz" },
                .module = "testing",
                .is_pure = false,
                .is_transitively_pure = false,
            } },            
                                    .{ .host_line = .{ .content = "// =============================================================================", .location = .{ .line = 924, .column = 0, .file = "/Users/larsde/src/koru/koru_std/testing.kz" }, .module = "testing" } },            
                                    .{ .host_line = .{ .content = "// Transform Implementation (Stub)", .location = .{ .line = 925, .column = 0, .file = "/Users/larsde/src/koru/koru_std/testing.kz" }, .module = "testing" } },            
                                    .{ .host_line = .{ .content = "// =============================================================================", .location = .{ .line = 926, .column = 0, .file = "/Users/larsde/src/koru/koru_std/testing.kz" }, .module = "testing" } },            
                                    .{ .host_line = .{ .content = "// The actual transform will:", .location = .{ .line = 928, .column = 0, .file = "/Users/larsde/src/koru/koru_std/testing.kz" }, .module = "testing" } },            
                                    .{ .host_line = .{ .content = "// 1. Parse source block as Koru AST", .location = .{ .line = 929, .column = 0, .file = "/Users/larsde/src/koru/koru_std/testing.kz" }, .module = "testing" } },            
                                    .{ .host_line = .{ .content = "// 2. Find mock definitions: lines matching `~event = branch { ... }`", .location = .{ .line = 930, .column = 0, .file = "/Users/larsde/src/koru/koru_std/testing.kz" }, .module = "testing" } },            
                                    .{ .host_line = .{ .content = "// 3. Extract the flow under test (non-mock lines)", .location = .{ .line = 931, .column = 0, .file = "/Users/larsde/src/koru/koru_std/testing.kz" }, .module = "testing" } },            
                                    .{ .host_line = .{ .content = "// 4. Trace flow to find impure events", .location = .{ .line = 932, .column = 0, .file = "/Users/larsde/src/koru/koru_std/testing.kz" }, .module = "testing" } },            
                                    .{ .host_line = .{ .content = "// 5. Error if impure event not mocked", .location = .{ .line = 933, .column = 0, .file = "/Users/larsde/src/koru/koru_std/testing.kz" }, .module = "testing" } },            
                                    .{ .host_line = .{ .content = "// 6. Error if mock unused", .location = .{ .line = 934, .column = 0, .file = "/Users/larsde/src/koru/koru_std/testing.kz" }, .module = "testing" } },            
                                    .{ .host_line = .{ .content = "// 7. Create mangled proc implementations for mocks", .location = .{ .line = 935, .column = 0, .file = "/Users/larsde/src/koru/koru_std/testing.kz" }, .module = "testing" } },            
                                    .{ .host_line = .{ .content = "// 8. Rewrite flow to call mangled versions", .location = .{ .line = 936, .column = 0, .file = "/Users/larsde/src/koru/koru_std/testing.kz" }, .module = "testing" } },            
                                    .{ .host_line = .{ .content = "// 9. Emit Zig test block", .location = .{ .line = 937, .column = 0, .file = "/Users/larsde/src/koru/koru_std/testing.kz" }, .module = "testing" } },            
                                    .{ .host_line = .{ .content = "// ~proc test {", .location = .{ .line = 939, .column = 0, .file = "/Users/larsde/src/koru/koru_std/testing.kz" }, .module = "testing" } },            
                                    .{ .host_line = .{ .content = "//     // TODO: Implement transform", .location = .{ .line = 940, .column = 0, .file = "/Users/larsde/src/koru/koru_std/testing.kz" }, .module = "testing" } },            
                                    .{ .host_line = .{ .content = "//     // For now, just parse and validate structure", .location = .{ .line = 941, .column = 0, .file = "/Users/larsde/src/koru/koru_std/testing.kz" }, .module = "testing" } },            
                                    .{ .host_line = .{ .content = "// }", .location = .{ .line = 942, .column = 0, .file = "/Users/larsde/src/koru/koru_std/testing.kz" }, .module = "testing" } },        
        ...
        .{ .proc_decl = ProcDecl{
            ...
            .is_pure = false,
            .is_transitively_pure = false,
            .location = .{ .line = 545, .column = 0, .file = "koru_std/io.kz" },
            .module = "io",
        } },
        .{ .host_line = .{ .content = "// ============================================================================", .location = .{ .line = 546, .column = 0, .file = "koru_std/io.kz" }, .module = "io" } },
        .{ .host_line = .{ .content = "// PRINT.BLK - Multi-line block printing with Source block (ZERO OVERHEAD)", .location = .{ .line = 547, .column = 0, .file = "koru_std/io.kz" }, .module = "io" } },
        .{ .host_line = .{ .content = "// ============================================================================", .location = .{ .line = 548, .column = 0, .file = "koru_std/io.kz" }, .module = "io" } },
        .{ .host_line = .{ .content = "//", .location = .{ .line = 549, .column = 0, .file = "koru_std/io.kz" }, .module = "io" } },
        .{ .host_line = .{ .content = "// Syntax: std.io:print.blk {", .location = .{ .line = 550, .column = 0, .file = "koru_std/io.kz" }, .module = "io" } },
        .{ .host_line = .{ .content = "//     Header: {{ title }}", .location = .{ .line = 551, .column = 0, .file = "koru_std/io.kz" }, .module = "io" } },
        .{ .host_line = .{ .content = "//     Value:  {{ count }}", .location = .{ .line = 552, .column = 0, .file = "koru_std/io.kz" }, .module = "io" } },
        .{ .host_line = .{ .content = "// }", .location = .{ .line = 553, .column = 0, .file = "koru_std/io.kz" }, .module = "io" } },
        .{ .host_line = .{ .content = "//", .location = .{ .line = 554, .column = 0, .file = "koru_std/io.kz" }, .module = "io" } },
        .{ .host_line = .{ .content = "// ARCHITECTURE:", .location = .{ .line = 555, .column = 0, .file = "koru_std/io.kz" }, .module = "io" } },
        .{ .host_line = .{ .content = "// - Takes a Source block (multi-line text)", .location = .{ .line = 556, .column = 0, .file = "koru_std/io.kz" }, .module = "io" } },
        .{ .host_line = .{ .content = "// - Parses {{ ... }} and {% if %} placeholders", .location = .{ .line = 557, .column = 0, .file = "koru_std/io.kz" }, .module = "io" } },
        .{ .host_line = .{ .content = "// - Generates inline Zig print statement", .location = .{ .line = 558, .column = 0, .file = "koru_std/io.kz" }, .module = "io" } },
        .{ .host_line = .{ .content = "//", .location = .{ .line = 559, .column = 0, .file = "koru_std/io.kz" }, .module = "io" } },
        .{ .host_line = .{ .content = "// This is NOT a regular event - it's a pure compile-time transformation.", .location = .{ .line = 560, .column = 0, .file = "koru_std/io.kz" }, .module = "io" } },
        .{ .event_decl = EventDecl{
            ...
            .location = .{ .line = 570, .column = 0, .file = "koru_std/io.kz" },
            .module = "io",
            .is_pure = false,
            .is_transitively_pure = false,
        } },
        .{ .event_decl = EventDecl{
            ...
            .location = .{ .line = 574, .column = 0, .file = "koru_std/io.kz" },
            .module = "io",
            .is_pure = false,
            .is_transitively_pure = false,
        } },
        .{ .proc_decl = ProcDecl{
            ...
            .is_pure = false,
            .is_transitively_pure = false,
            .location = .{ .line = 959, .column = 0, .file = "koru_std/io.kz" },
            .module = "io",
        } },
